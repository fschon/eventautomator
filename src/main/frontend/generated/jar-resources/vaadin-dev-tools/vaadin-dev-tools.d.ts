...
export declare class VaadinDevTools extends LitElement {
    ...
    getStatusColor(status: ConnectionStatus | undefined): "var(--dev-tools-green-color)" | "var(--dev-tools-grey-color)" | "var(--dev-tools-yellow-hsl)" | "var(--dev-tools-red-color)" | "none";
