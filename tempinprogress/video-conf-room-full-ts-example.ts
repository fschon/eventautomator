...
import type { SimulationScenario } from '../frontend/src/room/types';
...
// handles actions from the HTML
    const appActions = {
      connectWithFormInput: async () => {
        ...
        this.updateSearchParams(url, token, cryptoKey);
        ...
        const roomOpts: RoomOptions = {
          ...
          e2ee: e2eeEnabled
              ? { keyProvider: this.state.e2eeKeyProvider, worker: new E2EEWorker() }
              : undefined,
        };
        if (
